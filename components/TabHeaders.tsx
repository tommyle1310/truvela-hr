...
const TabHeaders = ({ id, title, currentProgress, icon, setCurrentProgress }: { id: number | string, currentProgress: string, title: string, icon?: IconDefinition, setCurrentProgress: (value: React.SetStateAction<string>) => void }) => {
    return (
        <Button
            key={id}
